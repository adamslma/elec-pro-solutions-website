        ...
        <div className="hero-inner">
          <div className="hero-copy" data-hero-copy>
            ...
            <h1 className="max-w-6xl">
              <span className="hero-line">Le courant passe.</span>
        ...
        <div className="section-shell method-layout">
          <div className="method-copy" data-reveal>
            ...
            <p>
              ...
              méthode rend chaque choix compréhensible, du diagnostic à la mise
              en service.
            </p>
        ...
        <div className="section-shell projects-layout">
          <div className="projects-intro" data-projects-intro>
            ...
            <p>
              ...
              perturbe plus : le travail reprend, la charge démarre, la lumière
              tombe juste.
            </p>
          </div>
